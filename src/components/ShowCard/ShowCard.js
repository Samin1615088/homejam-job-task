...
const ShowCard = (props) => {
    ...
    return (
        <div className="relative my-4 sm:my-8 showCard--size bg-secondary-coffee bg-gradient-to-r from-gradient-blue1 to-gradient-blue2" onClick={handleToggle}>
            <div className="absolute card showCard--size top-2 right-2">
